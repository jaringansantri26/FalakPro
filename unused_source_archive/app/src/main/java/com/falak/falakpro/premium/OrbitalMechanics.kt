...
object OrbitalMechanics {
    ...
    fun earthParallaxFactors(latGeographic: Double, heightM: Double): Pair<Double, Double> {
        ...
        val rhoSin = 0.99664719 * sin(u) + (heightM / AstroTransform.AA_EARTH_EQUATORIAL_RADIUS_M) * sin(latR)
        val rhoCos = cos(u) + (heightM / AstroTransform.AA_EARTH_EQUATORIAL_RADIUS_M) * cos(latR)
